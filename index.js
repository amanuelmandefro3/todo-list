...
const activities = JSON.parse(localStorage.getItem('todo')) || [];
...
const showData = (activities) => {
    if (activities.length > 0) {
        document.querySelector('#list').innerHTML = activities.map((activity) => `
        <div>
        ...
        document.querySelector('#list').innerHTML = `<h2>Add task to the list!</h2>`;
    }
}
